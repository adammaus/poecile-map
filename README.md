...
# Overview
* A simple visualization of the contact zone between Black-capped Chickadees and Carolina Chickadees.
* Also plots locations of last 30 iNaturalist observations of Poecile (Chickadees) that Need ID and an account has not reviewed. To use an account, fill in the `viewer_id` variable in map.html.
